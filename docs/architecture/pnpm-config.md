...
```json
{
  "packageManager": "pnpm@10.11.0+sha512.<hash>",
  "engines": {
    "node": ">=22.0.0 <23",
    "pnpm": ">=10.0.0 <11"
  }
...
> **Note**: The exact hash is generated by running `corepack use pnpm@10.11.0` which writes the
> full `packageManager` field with integrity hash automatically.
